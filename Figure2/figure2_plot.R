...
# figure 2-a ------------------------------------------------------------
gaugeDen.df <- fread(paste0(data.dir,'/precipitation_gauges/fig/all_loc_gauge_density_1degree.csv'))
...
# figure 2-b ------------------------------------------------------------
gaugeDen.df <- fread(paste0(data.dir,'/precipitation_gauges/fig/valid_loc_gauge_density_1degree.csv'))
